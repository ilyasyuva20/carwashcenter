...
if (usePostgres) {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS employees (id INTEGER PRIMARY KEY AUTOINCREMENT, branch_id INTEGER NOT NULL DEFAULT 1, name TEXT NOT NULL, phone TEXT, role TEXT NOT NULL DEFAULT 'washer', daily_wage REAL NOT NULL DEFAULT 0, monthly_salary REAL NOT NULL DEFAULT 0, joined_date TEXT, aadhaar_number TEXT, aadhaar_file TEXT);
    CREATE TABLE IF NOT EXISTS attendance (id INTEGER PRIMARY KEY AUTOINCREMENT, employee_id INTEGER NOT NULL, date TEXT NOT NULL, status TEXT NOT NULL, note TEXT, UNIQUE(employee_id, date));
    ...
    CREATE TABLE IF NOT EXISTS payroll (id INTEGER PRIMARY KEY AUTOINCREMENT, employee_id INTEGER NOT NULL, month INTEGER NOT NULL, year INTEGER NOT NULL, days_present REAL NOT NULL, daily_wage REAL NOT NULL, gross_pay REAL NOT NULL, total_advances REAL NOT NULL, net_pay REAL NOT NULL, paid_date TEXT, UNIQUE(employee_id, month, year));
